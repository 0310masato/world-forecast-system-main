...
Docs Stewardship、Operations Routine、Task Board / Handoff、CodexApp request、
AI Analysis Contract の
記入例は
`docs/examples/` に置きます。
...
requests は正本契約ではなく、正本は各 template、contract docs、type
definitions です。example
